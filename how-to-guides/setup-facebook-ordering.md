...
Choose "Page Tab". You will now need to fill in your store URL under "Secure Page Tab URL" and what you want to call your page tab under "Page Tab Name". Your store URL can either be your BYTO subdomain such as "[https://yourdomain.byto.com](https://yourdomain.byto.com)" or your custom domain name if setup
